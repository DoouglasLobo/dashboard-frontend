...
export function Sidebar() {
    return(
        <div className="flex w-full flex-col bg-muted/40">
            ...
            sm:flex flex-col">
                <nav className="flex flex-col items-center fap-4 px-2 py-5 gap-4">
                    <TooltipProvider>
                        <Link
                        href="#"
            ...
            <div className="sm:hidden flex flex-col sm:gap-4 sm:py4 sm:pl-14">
                <header 
